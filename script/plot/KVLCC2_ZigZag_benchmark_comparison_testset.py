...
prediction_files = [
    "KVLCC2_ZigZag_KPM_TestSet_prediction.csv",
    "KVLCC2_ZigZag_nuSVR_TestSet_prediction.csv",
    "KVLCC2_ZigZag_DE_RandomID=2_TestSet_prediction.csv",
    "KVLCC2_ZigZag_CG_RandomID=6_TestSet_prediction.csv"
]
states = [3, 4, 5]
...
def plot_accuracy_comparison(title):
    ...
    for idx, benchmark in enumerate(benchmarks):
        ...
        # 绘制Ground Truth作为参考
        if idx == 0:
            ax.plot(true_x, true_y, 'k--', label='GT')
