...
prediction_files = [
    "KVLCC2_Circle_KPM_TrainingSet_prediction.csv",
    "KVLCC2_Circle_nuSVR_TrainingSet_prediction.csv",
    "KVLCC2_Circle_DE_RandomID=0_TrainingSet_prediction.csv",
    "KVLCC2_Circle_CG_RandomID=9_TrainingSet_prediction.csv"
]
states = [3, 4, 5]
